...
function harder(){
    if(document.getElementById("correct").innerHTML == "There is some thing wrong you do, please restart" || document.getElementById("correct").innerHTML == "You can't make this correct!!"){
        document.getElementById("correct").innerHTML = "You can't make this correct!!"
    }
    else{
    high = 1000000 ; 
